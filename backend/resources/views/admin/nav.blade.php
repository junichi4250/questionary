<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 shadow-lg sticky top-0 z-50">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="http://localhost:8000/admin" class="flex items-center">
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">管理画面</span>
        </a>
        <div class="flex items-center md:order-2">
            ...
            <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                ...
                style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(1015px, 1038.5px, 0px);">
                <div class="py-3 px-4">
